...
<body class="bg-gray-100">
    <div class="container mx-auto py-8">
        <p class="text-center text-xl font-bold mb-4">{{$mensaje}}</p>
        <form class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6">
                <label for="comentario" class="block text-gray-700 text-sm font-bold mb-2">Comentario de la imagen:</label>
                <input type="text" name="comentario" id="comentario" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
